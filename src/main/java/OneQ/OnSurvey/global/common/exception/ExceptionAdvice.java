...
import OneQ.OnSurvey.global.infra.discord.notifier.ErrorAlertNotifier;
...
public class ExceptionAdvice {
    ...
    protected ErrorResponse<ExceptionResult.ServerErrorData> handleUntrackedException(
        ...
        errorAlertNotifier.sendErrorAlertAsync(e, req.getMethod(), req.getRequestURI(), req.getQueryString());
