...
public enum SurveyErrorCode implements ApiErrorCode {
    ...
    SURVEY_PARTICIPATION_TEMP_EXCEEDED("SURVEY_PARTICIPATION_TEMP_EXCEEDED_400", "설문 참여 가능 인원이 일시적으로 초과되었습니다.", HttpStatus.BAD_REQUEST),
    SURVEY_PARTICIPATION_OWN_SURVEY("SURVEY_PARTICIPATION_OWN_400", "본인이 생성한 설문에는 참여할 수 없습니다.", HttpStatus.BAD_REQUEST),
